...
if (isExist('.buss-swiper')) {
  const buss_swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.buss-swiper', {
    slidesPerView: 1,
    spaceBetween: 20,
    navigation: {
...
if (isExist('.content-history-swiper')) {
  const h_swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.content-history-swiper', {
    slidesPerView: 3,
    spaceBetween: 15,
    navigation: {
      prevEl: '.content-history-nav-btn.prev',
      nextEl: '.content-history-nav-btn.next'
    },
    breakpoints: {
      320: {
        slidesPerView: 1.5
...
if (isExist('.content-reviews-swiper')) {
  const r_swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.content-reviews-swiper', {
    slidesPerView: 1,
    spaceBetween: 10,
    navigation: {
      prevEl: '.content-reviews-nav-btn.prev',
      nextEl: '.content-reviews-nav-btn.next'
    }
  });
}

// auto padding for fix header

if (isExist('.main')) {
  const main = document?.querySelector('.main');
  const autoPaddingHeader = () => {
    const heightHeader = document.querySelector('.header').offsetHeight;
    main.style.paddingTop = `${heightHeader + 50}px`;
  };
  autoPaddingHeader();
}
if (isExist('.about-history-swiper')) {
  const h_swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.about-history-swiper', {
    slidesPerView: 3.5,
    spaceBetween: 40
  });
}
if (isExist('.about-reviews-swiper')) {
  const r_swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.about-reviews-swiper', {
    slidesPerView: 2,
    spaceBetween: 40,
    navigation: {
